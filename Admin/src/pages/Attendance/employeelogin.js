...
const Register = props => {
  ...
  const handleclick = async (e) =>{
    ...
    if (!data.password && !data.employeeid && !data.name){
      alert("Enter Name and EmployeeID and password")
    }
    else if(!data.name){
      alert('Enter Name')
    }
          ...
          <Row className="justify-content-center">
            <Col md={8} lg={6} xl={5}>
              <Card className="overflow-hidden">
                <div className="bg-login text-center">
                  ...
                  <div className="position-relative">
                    <h5 className="text-white font-size-20" onClick={handleclick}>Register</h5>
              ...
              <div className="mt-5 text-center">
                <p>Already have an account ? <a href="/employeelogin" className="fw-medium text-primary">
                  Login</a> </p>
